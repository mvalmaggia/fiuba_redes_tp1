...
class Server:
    ...
    def send_server(self, server_socket, client_address, packet):
        send(server_socket, client_address, packet, lambda seq_num: self.seq_nums_sent.get(client_address) == seq_num, 1, 5)
    ...
    def send_file_server(self, client_address, file_path):
        ...
        send_file(self.server_socket, client_address, file_path, initial_sec_num,
                  lambda seq_num: self.seq_nums_sent.get(client_address) == seq_num, 0.1, 5)
